  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    <div class="row">
      <ol class="breadcrumb">
        ...
        <li>Laporan</li>
        <li class="active">Pengguna Baru/Aktif</li>
      </ol>
    </div><!--/.row-->
...
?>
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Laporan Pengguna Baru/Aktif</h1>
      </div>
    </div><!--/.row-->
          ...
          <div class="panel-body">
            <div class="row">
              <form role="form" method="GET">
                ...
                <a href="#" onClick="MyWindow=window.open('laporan-pengguna.php?page=baru&data=cetak&tgl_awal=<?= $_GET['tgl_awal']; ?>&tgl_akhir=<?= $_GET['tgl_akhir']; ?>','MyWindow',',titlebar=no,toolbar=no,menubar=no,resizable=yes,width=1200,height=600'); return false;" class="btn btn-primary">Cetak</a>
                ...
                <table id="table" data-toggle="table"
                  data-url="laporan-pengguna.php?tgl_awal=<?= $_GET['tgl_awal']; ?>&tgl_akhir=<?= $_GET['tgl_akhir']; ?>&data=baru"
                ...
                <tr>
                    ...
                    <th data-field="tgl_submit" data-sortable="true">Tanggal Terdaftar</th>
                </tr>
                </thead>
            </table>
          </div>
