...
class Proses {
	...
	public function inbox() {
			$stmt = $this->conngammu->prepare("SELECT ReceivingDateTime as tgl_masuk, SenderNumber as pengirim, TextDecoded as pesan, Processed FROM inbox WHERE Processed = False ORDER BY ReceivingDateTime desc");
			$stmt->execute();
